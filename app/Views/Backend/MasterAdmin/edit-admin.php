                    ...
                    <h3>Edit Admin</h3>
                        ...
                        <form action="<?php echo base_url('admin/update-admin');?>" method="post">
                            <div class="form-group col-md-6">
                                ...
                                value="<?php echo $data_admin['nama_admin'];?>" required="required">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $data_admin['username_admin'];?>" 
                                ...
                                name="username" placeholder="Masukkan Username Pengguna" required="required">
                            </div>
