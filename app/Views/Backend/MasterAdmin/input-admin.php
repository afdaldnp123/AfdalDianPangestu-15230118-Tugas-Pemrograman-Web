                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo base_url('admin/simpan-admin'); ?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" onkeypress="return goodchars(event, 'abcdefghijklmnopqrstuvwxyz_ABCDEFGHIJKLMNOPQRSTUVWXYZ01234567890', this)" name="username" placeholder="Masukkan Username Admin" required="required">
                        </div>
                        <div style="clear:both;"></div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <a href="<?php echo base_url('admin/master-data-admin'); ?>" class="btn btn-danger">Batal</a></div>
                        </div>
                        <div style="clear:both;"></div>
                    </form>
                </div>
